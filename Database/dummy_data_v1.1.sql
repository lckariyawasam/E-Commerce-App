...
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
  (1, 1, '128GB', 'Silver', '699.99', 'IP12-001-128GB-Silver'),
  (2, 1, '128GB', 'Gold', '699.99', 'IP12-001-128GB-Gold'),
  (3, 2, '256GB', 'Black', '749.99', 'S21-001-256GB-Black'),
  (4, 2, '256GB', 'White', '749.99', 'S21-001-256GB-White'),
  (5, 3, '128GB', 'Black', '599.99', 'Pixel5-001-128GB-Black'),
  (6, 3, '64GB', 'White', '549.99', 'Pixel5-001-64GB-White'),
  (7, 4, '256GB', 'Black', '699.99', 'OP9-001-256GB-Black'),
  (8, 4, '128GB', 'Blue', '649.99', 'OP9-001-128GB-Blue'),
  (9, 5, '256GB', 'Black', '699.99', 'Mi11-001-256GB-Black'),
  (10, 5, '128GB', 'Blue', '649.99', 'Mi11-001-128GB-Blue'),

  -- Variants for TVs
  (11, 6, '55"', '4K', '799.99', 'TV55-001-55-4K'),
  (12, 6, '65"', '4K', '999.99', 'TV65-001-65-4K'),
  (13, 7, '65"', 'OLED', '1299.99', 'OLED65-001-65-OLED'),
  (14, 7, '55"', 'OLED', '1099.99', 'OLED55-001-55-OLED'),
  (15, 8, '60"', '4K', '849.99', 'TV60-001-60-4K'),
  (16, 8, '50"', '4K', '699.99', 'TV50-001-50-4K'),
  (17, 9, '50"', 'LED', '449.99', 'TV50-001-50-LED'),
  (18, 9, '43"', 'LED', '399.99', 'TV43-001-43-LED'),
  (19, 10, '43"', '1080p', '349.99', 'TV43-001-43-1080p'),
  (20, 10, '55"', '1080p', '449.99', 'TV55-001-55-1080p'),

  -- Variants for Laptops
  (21, 11, '256GB', '8GB', '799.99', 'LAP256-001-8GB-256GB'),
  (22, 11, '512GB', '16GB', '999.99', 'LAP512-001-16GB-512GB'),
  (23, 12, '256GB', '8GB', '749.99', 'LAP256-002-8GB-256GB'),
  (24, 12, '512GB', '16GB', '949.99', 'LAP512-002-16GB-512GB'),
  (25, 13, '512GB', '8GB', '849.99', 'LAP512-003-8GB-512GB'),
  (26, 13, '256GB', '16GB', '899.99', 'LAP256-003-16GB-256GB'),
  (27, 14, '512GB', '8GB', '899.99', 'LAP512-004-8GB-512GB'),
  (28, 14, '256GB', '16GB', '849.99', 'LAP256-004-16GB-256GB'),
  (29, 15, '1TB', '32GB', '1299.99', 'LAP1TB-005-32GB-1TB'),
  (30, 15, '512GB', '16GB', '1199.99', 'LAP512-005-16GB-512GB'),

  -- Variants for Headphones
  (31, 16, 'Black', 'Active Noise Cancelling', '199.99', 'HP-001-ANC-Black'),
  (32, 16, 'Silver', 'Active Noise Cancelling', '199.99', 'HP-001-ANC-Silver'),
  (33, 17, 'Black', 'Active Noise Cancelling', '189.99', 'HP-002-ANC-Black'),
  (34, 17, 'Silver', 'Active Noise Cancelling', '189.99', 'HP-002-ANC-Silver'),
  (35, 18, 'Black', 'Open-back', '179.99', 'HP-003-Open-Black'),
  (36, 18, 'Silver', 'Open-back', '179.99', 'HP-003-Open-Silver'),
  (37, 19, 'Black', 'Active Noise Cancelling', '199.99', 'HP-004-ANC-Black'),
  (38, 19, 'Silver', 'Active Noise Cancelling', '199.99', 'HP-004-ANC-Silver'),
  (39, 20, 'Black', 'Wireless', '149.99', 'HP-005-Wireless-Black'),
  (40, 20, 'White', 'Wireless', '149.99', 'HP-005-Wireless-White'),

  -- Variants for Cameras
  (41, 21, '30MP', 'Zoom Lens', '799.99', 'CAM-001-30MP-Zoom'),
  (42, 21, '24MP', 'Prime Lens', '699.99', 'CAM-001-24MP-Prime'),
  (43, 22, '24MP', 'Zoom Lens', '749.99', 'CAM-002-24MP-Zoom'),
  (44, 22, '30MP', 'Prime Lens', '799.99', 'CAM-002-30MP-Prime'),
  (45, 23, '30MP', 'Zoom Lens', '799.99', 'CAM-003-30MP-Zoom'),
  (46, 23, '24MP', 'Prime Lens', '699.99', 'CAM-003-24MP-Prime'),
  (47, 24, '24MP', 'Zoom Lens', '749.99', 'CAM-004-24MP-Zoom'),
  (48, 24, '30MP', 'Prime Lens', '799.99', 'CAM-004-30MP-Prime'),
  (49, 25, '24MP', 'Zoom Lens', '699.99', 'CAM-005-24MP-Zoom'),
  (50, 25, '30MP', 'Prime Lens', '749.99', 'CAM-005-30MP-Prime'),

  -- Variants for Watches
  (51, 26, '42mm', 'Space Gray', '249.99', 'WATCH-001-42mm-SpaceGray'),
  (52, 26, '38mm', 'Silver', '219.99', 'WATCH-001-38mm-Silver'),
  (53, 27, '45mm', 'Black', '269.99', 'WATCH-002-45mm-Black'),
  (54, 27, '41mm', 'Rose Gold', '239.99', 'WATCH-002-41mm-RoseGold'),
  (55, 28, '44mm', 'Black', '259.99', 'WATCH-003-44mm-Black'),
  (56, 28, '40mm', 'Silver', '229.99', 'WATCH-003-40mm-Silver'),
  (57, 29, '41mm', 'Gold', '239.99', 'WATCH-004-41mm-Gold'),
  (58, 29, '46mm', 'Silver', '269.99', 'WATCH-004-46mm-Silver'),
  (59, 30, '40mm', 'Blue', '229.99', 'WATCH-005-40mm-Blue'),
  (60, 30, '45mm', 'Black', '259.99', 'WATCH-005-45mm-Black');
  
  
-- Variants for Home Appliances with Price and SKU
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
  (61, 31, '600L', 'Stainless Steel', '999.99', 'APPLIANCE-001-600L-StainlessSteel'),
  (62, 31, '450L', 'Black', '799.99', 'APPLIANCE-001-450L-Black'),
  (63, 32, '8kg', 'White', '349.99', 'APPLIANCE-002-8kg-White'),
  (64, 32, '7kg', 'Silver', '299.99', 'APPLIANCE-002-7kg-Silver'),
  (65, 33, '1000W', 'Stainless Steel', '149.99', 'APPLIANCE-003-1000W-StainlessSteel'),
  (66, 33, '800W', 'Black', '129.99', 'APPLIANCE-003-800W-Black'),
  (67, 34, '10 Cups', 'Stainless Steel', '89.99', 'APPLIANCE-004-10Cups-StainlessSteel'),
  (68, 34, '8 Cups', 'Glass', '79.99', 'APPLIANCE-004-8Cups-Glass'),
  (69, 35, 'Corded', 'Purple', '119.99', 'APPLIANCE-005-Corded-Purple'),
  (70, 35, 'Cordless', 'Red', '129.99', 'APPLIANCE-005-Cordless-Red');


-- Variants for Gaming Consoles with Price and SKU
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
...
-- Variants for Smart Home Security with Price and SKU
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
...
-- Variants for Printers with Price and SKU
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
  (91, 46, '30 ppm', 'White', '299.99', 'PRINTER-001-30ppm-White'),
  (92, 46, '25 ppm', 'Black', '279.99', 'PRINTER-001-25ppm-Black'),
  (93, 47, '15 ppm', 'White', '199.99', 'PRINTER-002-15ppm-White'),
  (94, 47, '20 ppm', 'Black', '219.99', 'PRINTER-002-20ppm-Black'),
  (95, 48, '20 ppm', 'White', '229.99', 'PRINTER-003-20ppm-White'),
  (96, 48, '15 ppm', 'Black', '209.99', 'PRINTER-003-15ppm-Black'),
  (97, 49, '25 ppm', 'White', '259.99', 'PRINTER-004-25ppm-White'),
  (98, 49, '30 ppm', 'Black', '279.99', 'PRINTER-004-30ppm-Black'),
  (99, 50, '18 ppm', 'White', '229.99', 'PRINTER-005-18ppm-White'),
  (100, 50, '22 ppm', 'Black', '249.99', 'PRINTER-005-22ppm-Black');


-- Variants for Tablets with Price and SKU
INSERT INTO Ecom_platform.Variant (variant_id, Product_id, variant_attribute_value_1, variant_attribute_value_2, price, sku)
VALUES
  (101, 51, '128GB', 'Space Gray', '399.99', 'TABLET-001-128GB-SpaceGray'),
  (102, 51, '256GB', 'Silver', '499.99', 'TABLET-001-256GB-Silver'),
  (103, 52, '64GB', 'Mystic Black', '349.99', 'TABLET-002-64GB-MysticBlack'),
  (104, 52, '128GB', 'Mystic Silver', '399.99', 'TABLET-002-128GB-MysticSilver'),
  (105, 53, '128GB', 'Platinum', '449.99', 'TABLET-003-128GB-Platinum'),
  (106, 53, '256GB', 'Cobalt Blue', '499.99', 'TABLET-003-256GB-CobaltBlue'),
  (107, 54, '32GB', 'Black', '299.99', 'TABLET-004-32GB-Black'),
  (108, 54, '64GB', 'White', '349.99', 'TABLET-004-64GB-White'),
  (109, 55, '32GB', 'Black', '299.99', 'TABLET-005-32GB-Black'),
  (110, 55, '64GB', 'Aurora Black', '349.99', 'TABLET-005-64GB-AuroraBlack');
